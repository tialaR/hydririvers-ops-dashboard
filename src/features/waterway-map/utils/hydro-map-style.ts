...
export const hydroMapStyleTokens = {
  ...
  secondaryCasing: 'rgba(8, 32, 52, 0.65)',
  secondaryStroke: 'rgba(72, 128, 168, 0.38)',
  secondaryGlow: 'rgba(90, 160, 210, 0.1)',
  ...
  routeTrack: 'rgba(47, 224, 208, 0.12)',
  routeRemaining: 'rgba(47, 224, 208, 0.08)',
