import type { CargoCorridorId, OwnedCargo, OwnedCargoRiskLevel } from '@/features/cargo/owned/domain/owned-cargo-types';

type ShipperCorridorId = CargoCorridorId;
type ShipperOwnedCargo = OwnedCargo;
type ShipperRiskLevel = OwnedCargoRiskLevel;
