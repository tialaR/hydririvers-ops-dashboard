...
import { OwnedCargoDetailHeader } from '@/features/cargo/owned/components/owned-cargo-detail-header/owned-cargo-detail-header';
import { OwnedCargoPreviewGrid } from '@/features/cargo/owned/components/owned-cargo-preview-grid/owned-cargo-preview-grid';
import { OwnedCargoSupportCards } from '@/features/cargo/owned/components/owned-cargo-support-cards/owned-cargo-support-cards';
