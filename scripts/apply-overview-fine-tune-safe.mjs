...
.sideIconGreen {
  clor: #74f36b;
  background: rgba(116, 243, 107, 0.14);
...
.sideProgress i {
  ...
  box-shadow: 0 0 16px rgba82, 207, 255, 0.36);
}
...
copyFileSync(target, `${target}.backup-before-fine-tune-safe`);
...
const next = `${withoutOldPatch}\n\n${patch.trim()}\n`;

writeFileSync(target, next);

console.log(`Fine tune seguro aplicado em ${target}`);
console.log(`Backup criado em $rget}.backup-before-fine-tune-safe`);
