...
const REQUIRED_SCRIPTS = [
  ...
  'scripts/governance/flowlock.mjs',
  'scripts/governance/releaselock.mjs',
  'scripts/governance/sharklock-run.mjs',
  'scripts/governance/sharklock-capture.mjs',
  'scripts/governance/sharklock-certify.mjs',
  'config/agentic/flows/agentic-integrity.json',
  'config/agentic/flows/minhas-cargas-desktop.json',
  'config/agentic/releases/agentic-foundation.json',
  'config/agentic/releases/minhas-cargas-page61.json',
  'config/visual-gates/page-61.json',
  '.cursor/hooks.json',
